    ...
    case eDRAW_LIGHTING: 
        {
            ...
            renderer->SetPointLightSettings(m_lightComponent->m_color, m_transformation->GetTransformation()->GetTranslation(), m_transformation->GetTransformation()->GetScale().x);
