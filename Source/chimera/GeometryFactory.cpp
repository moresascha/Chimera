...
namespace chimera
{
    namespace d3d
    {
        Geometry* GeometryFactory::m_sScreenQuad = NULL;
        Geometry* GeometryFactory::m_sScreenQuadCPU = NULL;
        Geometry* GeometryFactory::m_sSphere = NULL;
        Geometry* GeometryFactory::m_sCube = NULL;
        Geometry* GeometryFactory::m_sDefCube = NULL;
        Geometry* GeometryFactory::m_sFrustumGeomety = NULL;
        Geometry* GeometryFactory::m_sSkyDome = NULL;
        Geometry* GeometryFactory::m_sLine = NULL;

        GeometryFactory::GeometryFactory(VOID) {
        }

        Geometry* GeometryFactory::GetGlobalLineCPU(VOID)
        {
            if(m_sLine)
            {
                return m_sLine;
        ...
        Geometry* GeometryFactory::GetFrustumGeometry(VOID)
        {
            ...
            m_sFrustumGeomety = new Geometry();
        ...
        Geometry* _CreateScreenQuad(D3D11_CPU_ACCESS_FLAG flags)
        {
        ...
        Geometry* GeometryFactory::GetGlobalScreenQuad(VOID) 
        {
            if(!m_sScreenQuad)
            {
        ...
        Geometry* GeometryFactory::GetGlobalScreenQuadCPU(VOID)
        {
            if(!m_sScreenQuadCPU)
            {
        ...
        Geometry* GeometryFactory::CreateScreenQuad(VOID)
        {
            return _CreateScreenQuad((D3D11_CPU_ACCESS_FLAG)0);
        }

        Geometry* GeometryFactory::CreateScreenQuadCPUAcc(VOID)
        {
            return _CreateScreenQuad(D3D11_CPU_ACCESS_WRITE);
        }

        Geometry* GeometryFactory::GetGlobalDefShadingCube(VOID)
        {
            if(m_sDefCube)
            {
                return m_sDefCube;
            }
            m_sDefCube = new Geometry();
        ...
        Geometry* GeometryFactory::GetGlobalBoundingBoxCube(VOID)
        {
            if(m_sCube)
            {
                return m_sCube;
        ...
        Geometry* GeometryFactory::CreateSphere(UINT segmentsX, UINT segmentsY, BOOL deleteRawData)
        {
            /*UINT segmentsX = 32;
            UINT segmentsY = 16; */
        ...
        Geometry* GeometryFactory::GetSphere(VOID)
        {
            if(m_sSphere)
            {
                return m_sSphere;
        ...
        Geometry* GeometryFactory::GetSkyDome(VOID)
        {
            if(m_sSkyDome)
            {
                return m_sSkyDome;
        ...
        Geometry* GeometryFactory::CreateNormedGrid(UINT xtiles, UINT ztiles, FLOAT scale, BOOL deleteRawData)
        {
        ...
        Geometry* GeometryFactory::CreateAlternatingNormedGrid(UINT xtiles, UINT ztiles, FLOAT scale, BOOL deleteRawData)
        {
            UINT indexCount = (4 + (xtiles-1) * 2) * ztiles + ztiles;
            UINT vertexCount = (xtiles + 1) * (ztiles + 1);
            UINT vertexStride = 8;
